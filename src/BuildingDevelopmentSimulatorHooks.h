...
namespace BuildingDevelopmentSimulatorHooks
{
	void Install();
	bool IsSupportedGameVersion();

	void ToggleIgnoreCapsCheatState(cISC4BuildingDevelopmentSimulator* pBuildingDevelopmentSimulator);
	void ToggleDebugGrowthCheatState(cISC4BuildingDevelopmentSimulator* pBuildingDevelopmentSimulator);
}