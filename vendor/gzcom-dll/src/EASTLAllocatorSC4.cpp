...
// This file implements an EASTL allocator that uses SC4's memory pool.
...
namespace eastl
{
	...
	{
		return true; // All allocators are considered equal, as they use SC4's memory pool.
	}

	bool operator!=(const allocator&, const allocator&)
	{
		return false; // All allocators are considered equal, as they use SC4's memory pool.
	}
