...
class cISC4Lot : public cIGZUnknown
{
	public:
		...
		virtual uint32_t GetBuildingType(bool bUnknown) const = 0;
		...
		virtual uint32_t GetCapacity(uint32_t dwWealthType) const = 0;
		virtual uint32_t GetCapacity(uint32_t dwDeveloperType, bool bForceCalculation) const = 0;
		virtual uint32_t GetAvailableCapacity(uint32_t dwDeveloperType, bool bForceCalculation) const = 0;

		virtual uint32_t GetPopulation(uint32_t dwDeveloperType) const = 0;
		virtual uint32_t GetPopulations(void) const = 0;
		virtual bool SetPopulation(uint32_t dwDeveloperType, uint16_t wPopulation) = 0;

		virtual uint32_t GetTravelPopulation(uint32_t dwDeveloperType) const = 0;
		...
		virtual float GetTravelJobs(uint32_t dwWealthType) const = 0;
