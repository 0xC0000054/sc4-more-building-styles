...
public:
	...
	virtual void GetConstructionInfo(cISC4BuildingDevelopmentSimulator::ConstructionProfile* pConstructionProfile) = 0;

	virtual bool GrowthAndDeclineListsAreValid() = 0;
	virtual intptr_t GetGrowthList() = 0; // Returns a vector<cISC4GrowthDeveloper::GrowthItem>
	virtual intptr_t GetDeclineList() = 0; // Returns a vector<cISC4GrowthDeveloper::GrowthItem>
