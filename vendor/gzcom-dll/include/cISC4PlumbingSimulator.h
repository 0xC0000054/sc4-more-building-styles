...
class cISC4PlumbingSimulator : public cIGZUnknown
{
	public:
		...
		virtual intptr_t GetSupplyValue(int unknown1) = 0;
		virtual bool GetSupplyValueMapPtr(cISC4SimGrid<unsigned char>*& grid) = 0;
		virtual cISC4SimGrid<unsigned char>* GetWateredGrid() = 0;

		virtual bool AreWateredBuildingsInCell(int cX, int cZ) = 0;
		virtual bool IsBuildingWatered(cISC4Occupant* unknown1) = 0;
		virtual uint32_t GetWaterProduction(cISC4Occupant* unknown1) = 0;
		virtual bool IsCellWatered(int unknown1) = 0;
